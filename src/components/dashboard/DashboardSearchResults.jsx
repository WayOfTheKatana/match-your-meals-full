...
import { Search, Loader2, AlertCircle, ChefHat, Clock, Users, Heart, BookOpen, Check, Plus } from 'lucide-react';
...
const DashboardSearchResults = ({ 
  ...
  const { user } = useAuth();
  const [selectedRecipeForBoard, setSelectedRecipeForBoard] = React.useState(null);
