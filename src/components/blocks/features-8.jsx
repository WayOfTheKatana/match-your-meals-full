...
export function Features() {
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <div className="pt-4 text-center text-lg font-inter font-light leading-tight">From Community Recipe  Creators, who loves to serve you</div>
                            </CardContent>
                        </Card>
    ...
    <path
        ...
        d="M85 35C85 51.5685 71.5685 65 55 65C38.4315 65 25 51.5685 25 35C25 18.4315 38.4315 5 55 5C71.5685 5 85 18.4315 85 35ZM77 35C77 22.8497 67.1503 13 55 13C42.8497 13 33 22.8497 33 35C33 47.1503 42.8497 57 55 57C67.1503 57 77 47.1503 77 35Z"
        fill="currentColor"
    />
    ...
    <path
        className="text-zinc-400 dark:text-zinc-600"
        d="M72.5 57.5L95 80C96.1046 81.1046 96.1046 82.8954 95 84C93.8954 85.1046 92.1046 85.1046 91 84L68.5 61.5C69.8807 60.1193 71.1193 58.8807 72.5 57.5Z"
        fill="currentColor"
    />

    <!-- AI Brain/Neural Network Pattern -->
    <g clipPath="url(#clip0_ai_search)">
        <!-- Central Brain Core -->
        <circle
            cx="155"
            cy="35"
            r="12"
            fill="url(#paint0_ai_gradient)"
            className="text-primary-600 dark:text-primary-500"
        />
        
        <!-- Neural Connections -->
        <path
            d="M143 25C143 22.2386 145.239 20 148 20C150.761 20 153 22.2386 153 25C153 27.7614 150.761 30 148 30C145.239 30 143 27.7614 143 25Z"
            fill="url(#paint1_ai_gradient)"
        />
        
        <path
            d="M157 25C157 22.2386 159.239 20 162 20C164.761 20 167 22.2386 167 25C167 27.7614 164.761 30 162 30C159.239 30 157 27.7614 157 25Z"
            fill="url(#paint1_ai_gradient)"
        />
        
        <path
            d="M143 45C143 42.2386 145.239 40 148 40C150.761 40 153 42.2386 153 45C153 47.7614 150.761 50 148 50C145.239 50 143 47.7614 143 45Z"
            fill="url(#paint1_ai_gradient)"
        />
        
        <path
            d="M157 45C157 42.2386 159.239 40 162 40C164.761 40 167 42.2386 167 45C167 47.7614 164.761 50 162 50C159.239 50 157 47.7614 157 45Z"
            fill="url(#paint1_ai_gradient)"
        />
        
        <!-- Connection Lines -->
        <path
            d="M148 30L155 35M162 30L155 35M148 40L155 35M162 40L155 35"
            stroke="url(#paint2_ai_gradient)"
            strokeWidth="2"
            strokeLinecap="round"
        />
        
        <!-- Additional Neural Nodes -->
        <circle cx="130" cy="35" r="6" fill="url(#paint1_ai_gradient)" />
        <circle cx="180" cy="35" r="6" fill="url(#paint1_ai_gradient)" />
        <circle cx="155" cy="15" r="6" fill="url(#paint1_ai_gradient)" />
        <circle cx="155" cy="55" r="6" fill="url(#paint1_ai_gradient)" />
        
        <!-- Extended Connections -->
        <path
            d="M136 35L143 35M167 35L174 35M155 21L155 29M155 41L155 49"
            stroke="url(#paint2_ai_gradient)"
            strokeWidth="1.5"
            strokeLinecap="round"
            opacity="0.7"
    ...
    <g className="text-primary-600 dark:text-primary-500">
        <circle cx="45" cy="100" r="3" fill="currentColor" opacity="0.6">
            <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" />
        </circle>
        <circle cx="65" cy="105" r="2" fill="currentColor" opacity="0.8">
            <animate attributeName="opacity" values="0.4;1;0.4" dur="1.8s" repeatCount="indefinite" />
        </circle>
        <circle cx="85" cy="95" r="2.5" fill="currentColor" opacity="0.7">
    ...
    <!-- Text/Code Lines representing search results -->
    <g className="text-zinc-400 dark:text-zinc-600">
        <rect x="25" y="120" width="60" height="3" rx="1.5" fill="currentColor" opacity="0.6" />
        <rect x="25" y="128" width="80" height="3" rx="1.5" fill="currentColor" opacity="0.4" />
        <rect x="25" y="136" width="45" height="3" rx="1.5" fill="currentColor" opacity="0.5" />
        
        <rect x="120" y="120" width="70" height="3" rx="1.5" fill="currentColor" opacity="0.6" />
        <rect x="120" y="128" width="55" height="3" rx="1.5" fill="currentColor" opacity="0.4" />
        <rect x="120" y="136" width="65" height="3" rx="1.5" fill="currentColor" opacity="0.5" />
    </g>

    <defs>
        <!-- AI Gradient Definitions -->
        <linearGradient id="paint0_ai_gradient" x1="155" y1="23" x2="155" y2="47" gradientUnits="userSpaceOnUse">
            <stop className="text-primary-600 dark:text-primary-500" stopColor="currentColor" />
            <stop className="text-primary-400 dark:text-primary-300" offset="1" stopColor="currentColor" stopOpacity="0.7" />
        </linearGradient>
        
        <linearGradient id="paint1_ai_gradient" x1="0" y1="0" x2="1" y2="1" gradientUnits="objectBoundingBox">
            <stop className="text-primary-500 dark:text-primary-400" stopColor="currentColor" stopOpacity="0.8" />
            <stop className="text-primary-600 dark:text-primary-500" offset="1" stopColor="currentColor" />
        </linearGradient>
        
        <linearGradient id="paint2_ai_gradient" x1="0" y1="0" x2="1" y2="1" gradientUnits="objectBoundingBox">
            <stop className="text-primary-600 dark:text-primary-500" stopColor="currentColor" stopOpacity="0.6" />
            <stop className="text-primary-400 dark:text-primary-300" offset="1" stopColor="currentColor" stopOpacity="0.3" />
        </linearGradient>
        
        <clipPath id="clip0_ai_search">
            <rect width="70" height="50" fill="white" transform="translate(120, 10)" />
        </clipPath>
    </defs>
</svg>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground font-inter font-light">Say what you want to cook and our AI finds the perfect recipe instantly.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                                    ...
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            ...
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=100" alt="" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=100" alt="" />
                                            </div>
                                        ...
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            ...
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?auto=compress&cs=tinysrgb&w=100" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
