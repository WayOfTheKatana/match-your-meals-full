  ...
  const features = [
    {
      ...
      description:
        `
Just type "quick breakfast for kids" or "low-carb dinner" and get exactly what you need. No keyword guessing.`,
...
,
    },
    {
      title: "Voice Search",
      description:
        `Too busy to type? Just say "find me a 20-minute pasta recipe" and we'll handle the rest.`,
...
,
    ...
    {
      title: "Healthy Recipe Focus",
      description: "Every recipe shows nutrition info, so you can cook with confidence knowing what goes into your body.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
...
,
  ...
  <path d="m10.933 19.231-7.668-4.13-1.37.739a.75.75 0 0 0 0 1.32l9.75 5.25c.221.12.489.12.71 0l9.75-5.25a.75.75 0 0 0 0-1.32l-1.37-.738-7.668 4.13a2.25 2.25 0 0 1-2.134-.001Z" />
    ...
    },
    {
      ...
      description:
        "Find recipes by time (under 30 mins), ingredients you have, or dietary needs in seconds.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
...
,
    },
    {
      ...
      description:
        "Listen to instructions while you cook - perfect when your hands are messy or you're multitasking.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
...
,
    ...
    {
      title: "Follow Food Creators",
      description: "Discover amazing home cooks and follow them for new recipe inspiration delivered to your feed.",
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
