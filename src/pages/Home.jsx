...
const Home = () => {
  ...
  return (
    <>
      {/* Hero Section with proper z-index management */}
      <div className="min-h-screen relative overflow-hidden">
        {/* Background with GridMotion - Lowest layer */}
        <div className="absolute inset-0 z-0">
          <GridMotion items={gridItems} gradientColor="rgba(211, 84, 0, 0.7)" />
        </div>

        {/* Dark overlay for better text readability - Above background */}
        <div className="absolute inset-0 bg-black/40 z-[1]"></div>

        {/* Header - Higher than content but lower than mobile drawer */}
        ...
        {/* Main content - Above overlay but below header */}
        <div className="relative z-[10] flex flex-col min-h-screen">
          <main className="flex-1 flex items-center justify-center py-12 pt-24">
            {/* SearchSection with enhanced styling for better visibility over the grid */}
            <div className="relative z-[20] w-full max-w-7xl mx-auto px-4">
